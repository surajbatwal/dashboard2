...
@Component({
  selector: 'app-archerportal',
  templateUrl: './archerportal.component.html',
  styleUrls: ['./archerportal.component.css']
})
export class ArcherportalComponent implements OnInit {
